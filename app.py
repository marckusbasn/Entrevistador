...
(O restante das regras, como PROTOCOLO DE EMOÇÕES, ANTI-CONSELHOS, etc., permanecem as mesmas)
"""
...
def pagina_entrevistador():
    ...
    def classificar_intencao(prompt_utilizador):
        ...
        prompt_classificador = f"""... (prompt completo do classificador) ..."""
        # ... (código completo)
        pass
    ...
    if "model" not in st.session_state:
        # Inicializa o modelo principal logo de início
    ...
    if prompt := st.chat_input("Sua resposta...", key="chat_input", disabled=st.session_state.get('interview_over', False)):
        ...
        with st.chat_message("assistant"):
            ...
            # A lógica agora é uma só para todas as interações
