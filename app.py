...
# (O texto completo das orientações, incluindo a REGRA 2.1 sobre emoções, permanece aqui)
...
# ==============================================================================
# PÁGINA DE ADMINISTRAÇÃO E FUNÇÕES GERAIS
# ==============================================================================
# (As funções pagina_configuracao, formatar_para_nvivo, etc., permanecem as mesmas)
# (O código completo e funcional está no final da resposta)

# ==============================================================================
# PÁGINA DO ENTREVISTADO (LÓGICA PRINCIPAL)
# ==============================================================================
def pagina_entrevistador():
    ...
    # <<< ALTERAÇÃO CRÍTICA AQUI NO PROMPT DO CLASSIFICADOR >>>
    def classificar_intencao(prompt_utilizador):
        ...
        1. 'ENTREVISTA': O utilizador está a responder a uma pergunta da entrevista, expressando sentimentos, ou pedindo um esclarecimento sobre a última pergunta feita pelo entrevistador.
    ...
    # O restante da página do entrevistador permanece o mesmo.
    pass
...
# Substitua as definições de função vazias pelas completas
